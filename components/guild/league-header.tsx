  ...
  return (
    <div className="flex items-center justify-between border-b border-border bg-card/30 px-5 py-3">
      ...
      <div className="flex flex-col">
        <h1 className="text-lg font-bold text-foreground">联赛总览</h1>
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Season Selector */}
        <button className="flex items-center gap-1.5 rounded-lg border border-border bg-secondary/50 px-2.5 py-1.5 text-xs text-foreground hover:bg-secondary">
          <span>2025 春季赛</span>
